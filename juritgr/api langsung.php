...
-->
	...
	<table width="59%" height="106" class="table table-bordered">
	<tr class="text-center" bgcolor="#FFFF00">
		<td width="6%" rowspan="2">UNDIAN</td>
		<td width="10%" rowspan="2">GOLONGAN</td>
		<td width="9%" rowspan="2">NAMA PESILAT</td>
		<td width="14%" rowspan="2">KONTINGEN</td>
		<td colspan="3"><span class="style2">UNSUR NILAI</span></td>
		<td width="8%" rowspan="2"><span class="style2">HUKUMAN</span></td>
		<td width="5%" rowspan="2"><span class="style2">NILAI /JURI</span></td>
		<td width="22%" rowspan="2"> TOTAL NILAI</td>
	</tr>
	<tr class="text-center" bgcolor="#FFFF00">
		<td width="10%"><span class="style2">SERANG/BELA</span></td>
		<td width="11%"><span class="style2">KEMANTAPAN</span></td>
		<td width="5%"><span class="style2">SERASI</span></td>
	</tr>
	<?php
...
function get_data_view_regu()
{
	...
	include "../backend/includes/connection.php";
?>
	<table width="799" height="90" class="table table-bordered">
	<tr class="text-center" bgcolor="#FFFF00">
		<td width="90" rowspan="2">NO UNDIAN</td>
		<td width="90" rowspan="2">GOLONGAN</td>
		<td width="113" rowspan="2">NAMA PESILAT</td>
		<td width="94" rowspan="2">KONTINGEN</td>
		<td colspan="2"><span class="style2">UNSUR NILAI</span></td>
		<td width="82" rowspan="2"><span class="style2">HUKUMAN</span></td>
		<td width="82" rowspan="2"><span class="style2">NILAI /JURI</span></td>
		<td width="54" rowspan="2">TOTAL NILAI</td>
	</tr>
	<tr class="text-center" bgcolor="#FFFF00">
		<td width="96"><span class="style2">KEBENARAN</span></td>
		<td width="110"><span class="style2">KEMANTAPAN</span></td>
	</tr>
	<?php 
...
function get_data_view_tunggal()
{
	...
	include "../backend/includes/connection.php";
?>
	<table width="800" height="89" class="table table-bordered">
	<tr class="text-center" bgcolor="#FFFF00">
		...
		<td colspan="2"><span class="style2">UNSUR NILAI</span></td>
		<td rowspan="2"><span class="style2">HUKUMAN</span></td>
		<td rowspan="2"><span class="style2">NILAI /JURI</span></td>
		<td rowspan="2"> TOTAL NILAI</td>
	</tr>
	<tr class="text-center" bgcolor="#FFFF00">
		<td><span class="style2">KEBENARAN</span></td>
		<td><span class="style2">KEMANTAPAN</span></td>
	</tr>
	<?php 
	 $no = 0;
...
function partai()
{
	...
	while($item = mysqli_fetch_array($exec)):
		$result[$key]['id'] = $item['id_partai'];
		$result[$key]['name'] = $item['noundian'] .' - '. $item['nama'];
